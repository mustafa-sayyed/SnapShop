    ...
    <div>
      ...
      <div className="flex flex-col justify-center gap-10 my-10 mb-28 md:flex-row">
        ...
        <div className="flex flex-col justify-center items-start gap-6">
          ...
          <p className="text-gray-500">413002 Begum peth <br /> 340, Solapur, India</p>
          <p className="text-gray-500">Tel (+91) 9012345678 <br /> Email: mustafasayyed@ms.com</p>
          <p className="font-semibold text-xl text-gray-600">Careers at Nothing</p>
